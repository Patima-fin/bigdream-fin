...
window.WTP_CONFIG = {
  ...
  // ── อัตราภาษีหัก ณ ที่จ่าย (WHT) ที่ลูกค้าหักจากใบแจ้งหนี้ของเรา ────────────
  //  ใช้คำนวณ "คาดรับสุทธิ" ในหน้าใบแจ้งหนี้คงค้าง:
  //     คาดรับสุทธิ = balance × (1.07 − WHT_RATE) / 1.07 − ภาระหนี้
  //  (balance = ยอดเต็มรวม VAT 7% แล้ว · WHT หักจากยอด "ก่อน VAT")
  //   0.03 = ค่าบริการ/ค่าจ้างทำของ (BIGDREAM — ที่ปรึกษากลยุทธ์)
  //   0.01 = งานรับเหมา/ขนส่ง (BIOAXEL, Water POG ใช้ค่านี้)
  //  ★ ถ้ามีทั้งงานบริการและงานรับเหมาปนกัน ต้องแยกเป็นราย IV — ตอนนี้ระบบใช้อัตราเดียวทั้งเว็บ
  WHT_RATE: 0.03,
