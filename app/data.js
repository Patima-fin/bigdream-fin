// BIGDREAM Financial Dashboard – mock data store with localStorage persistence.
...
(function () {
  const STORAGE_KEY = 'bdh-fin-data-v8';
  ...
  const seed = () => ({
    meta: {
      companyName: 'บริษัท บิ๊ก ดรีม โฮลดิง จำกัด',
      shortName: 'BIGDREAM',
      asOf: '2026-05-18',
      year: 2026,
      currency: 'THB',
    ...
    // ── 02. Pipeline summary (War Room) — zeroed for BIGDREAM (not maintained by sync) ──
    pipeline: {
    ...
    // ── War Room P1 / P2 — zeroed for BIGDREAM (pre-computed from Google Sheet; not synced) ──
    warroomP1: {
    ...
    // ── YTD / weekly / monthly — zeroed for BIGDREAM ──────────────────────────
    ytdRevenue: [],
  ...
  //     (เคยเกิดกับ BIGDREAM: seed Water POG หลุดเข้า DB — ดู CLAUDE.md 2026-06-18).
